...
def create_patent_analysis_crew(model_name="llama3"):
    ...
    task1 = Task(
        description="""
        Define a research plan for thermonucler fusion patents:
    ...
    task2 = Task(
        description="""
        Using the research plan, retrieve patents related to thermonuclear fusion technology from the last 3 years.
        ...
        Group patents by sub-technologies within thermonuclear fusion.
    ...
    task3 = Task(
        ...
        4. Determine emerging sub-technologies within thermonuclear fusion
    ...
    task4 = Task(
        description="""
        Based on the patent analysis, predict future innovations in thermonuclear fusion technology:
...
def run_patent_analysis(research_area="Thermonuclear Fusion", model_name="llama3"):
    """
    Run the patent analysis crew for the specified research area.

    Args:
        research_area (str): The research area to analyze (e.g., "Thermonuclear Fusion")
...
if __name__ == "__main__":
    ...
    research_area = input(
        "Enter the research area to analyze (default: Thermonuclear Fusion): "
    )
    if not research_area:
        research_area = "Thermonuclear Fusion"
